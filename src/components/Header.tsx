...
export default function Header() {
  ...
  return (
    <header className="bg-background/90 supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50 w-full border-b">
      <div className="size-full backdrop-blur-sm">
        <div className="container m-auto flex items-center justify-between px-4 py-2">
          <Link to="/" className="flex items-center gap-2">
            ...
            />
            <h1 className="font-nexa text-xl font-bold sm:text-2xl">
              Weatherly
            </h1>
          </Link>
