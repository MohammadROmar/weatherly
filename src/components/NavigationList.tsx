...
function NavigationList({ isOpen = false }: NavigationListProps) {
  return (
    <nav
      className={`max-md:bg-background/90 max-md:supports-[backdrop-filter]:bg-background/60 backdrop-blur-sm max-md:fixed max-md:top-0 max-md:right-0 max-md:left-0 max-md:-z-50 max-md:border-b max-md:transition-transform max-md:duration-300 max-md:ease-in-out md:text-sm ${isOpen ? 'max-md:translate-y-0' : 'max-md:-translate-y-[450%]'}`}
    >
